...
<head>
    ...
    <title>Contacts/ Contact Message || <?php echo SITE_NAME; ?></title>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="email" class="form-control" name="email"
                                            value="<?php    echo $showemail ?>" required>
                                    </div>
                                    <label for="inputNumber" class="col-sm-2 col-form-label">Subject :</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" value="<?php    echo $showsubject ?>"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" class="form-control"
                                            name="message"><?php    echo $showmessage ?></textarea>
                                    </div>
                                </div>

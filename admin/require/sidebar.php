...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if($page != "vendor"){echo "collapsed";} ?>"
                href="vendor.php">
                <i class="bi bi-building"></i>
                <span>Vendors</span>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link <?php if($page != "Contact"){echo "collapsed";} ?>" href="contact.php">
        ...
        <li class="nav-item<?php if($page == "Admission Query"|| $page == "Contact Send" ){echo "active";} ?>">
            <a class="nav-link <?php if($page == "Admission Query"|| $page == "Contact Send" ){echo "noaction";}else {
                echo "collapsed"; 
            ...
            <ul id="forums-nav"
                class="nav-content collapse <?php if($page == "Admission Query"|| $page == "Contact Send" ){echo "show";} ?> "
                data-bs-parent="#sidebar-nav">
                <li>
                ...
                <li>
                <a href="message_show.php" <?php if($page == "Contact Send"  ){echo "class='active'";} ?>>
                        <i class="bi bi-circle"></i><span>Contact Send</span>
                    </a>
                </li>
            </ul>
        </li>

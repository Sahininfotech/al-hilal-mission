...
<head>
    ...
    <title>Exam Details || <?php echo SITE_NAME; ?></title>
                            ...
                            <div class="card recent-sales overflow-auto p-4">
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    $i=1;
                                        ...
                                        $showsubject_id = $showrow['subject_id'];
                                    ...
                                    <td><?php    echo $showsession    ?></td>
                                            ...
                                            <a href='ajax/unit-delete.ajax.php?id=<?php    echo $showrow['id']  ?>'>

                                                <i class="bi bi-trash" data-bs-toggle="modal"

                                                    data-bs-target="#deleteclassFormModal"

                                                    onclick="return deletunit();"></i>
...
return confirm("Are you sure that you want to delete the Exam Contents ?");

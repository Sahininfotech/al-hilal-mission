...
$Admin = new  Admin();
  ...
  if(isset($_POST["submit"])){
    ...
    $image_size       = $_FILES[ 'upload_img' ][ 'size' ];
    $image_tmp_name   = $_FILES[ 'upload_img' ][ 'tmp_name' ];
...
<head>
    ...
    <title>Pages / Register || <?php echo SITE_NAME; ?></title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <label for="yourAddress" class="form-label">Profile Photo</label>

                                            <input class="form-control" maxlength="200" type="file" name="upload_img"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <button
                                                class="btn btn-primary text-center createacccss d-flex m-auto justify-content-center"
                                                type="submit" name="submit">Create Account</button>

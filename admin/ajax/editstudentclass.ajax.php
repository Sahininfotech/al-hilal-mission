...
<body>
    ...
    <form method="POST" action="student-update.ajax.php" enctype="multipart/form-data" runat="server">
        ...
        <div class="card ps-4 pe-4 mb-0" style="box-shadow: none">
            ...
            <input type="hidden" maxlength="80" class="form-control" name="id" value="<?php    echo $showid ?>"
                required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img src="<?php    echo $image ?>" width=110 height=105 alt=""
                        onerror="this.src='../assets/img/user.jpg';" width=100 height=100 class="rounded-circle"
                        id="output">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" maxlength="80" class="form-control" name="name"
                        value="<?php    echo $showname ?>" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <select maxlength="80" class="form-control" id="form-select" aria-label="Default select example"
                        name="status">

                        <option value="<?php    echo $showstatus ?>"><?php    echo $showstatus ?></option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="number" maxlength="10" class="form-control" value="<?php    echo $showcontact_no ?>"

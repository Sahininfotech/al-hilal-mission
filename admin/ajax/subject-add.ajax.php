...
$showClasses = $Classes->classesList();
  ...
  if(isset ($_POST["submit"])){
    ...
    $added = $Subjects->addSubject($class_name, $subject, $description, $stream);
    ...
    <form method="post" class="m-0 w-100" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div class="card mb-0" style="box-shadow: none">
            <div class="card-body px-3 py-0">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label" id="demo2" style="display: none;">Stream :</label>
                    <div class="col-sm-9">
                        <select class="form-select" name="stream" id="demo3" style="display: none;"

   ...
   $StudentDetails         = new StudentDetails();
    ...
    $insertEmpQuery=false;
...

     {
       ...
       $result         = $Student->addtStudent($student_id, $name,  $email, $gurdian_name, $contact_no, $gender, $post_office, $police_station, $pin_code, $sdo, $district, $state, $date_of_birth, $class, $stream, $address, $academic_year, $status, $roll_no, $image, $total_amount);

...
// }
    ...
    if (isset($_POST['submit'])) {
        ...
        $updated = $FeesAccount->editMonthlyfees($amount,$Id);

        if ($updated) {

            echo '<script>alert("Monthly Fees Updated!")</script>';

            

        }else {

            echo '<script>alert("Failed to update Monthly Fees.")</script>';
...
$feeAcc = $FeesAccount->monthlyfeesById($_GET['feesdata']);
    ...
    <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
        ...
        <div class="card mb-0" style="box-shadow: none">
            ...
            <div class="card-body p-3">
                ...
                <h5 class="card-title d-flex justify-content-center p-0 mt-0 my-5">Update Monthly Fees Structure </h5>
                ...
                <div class="row p-0 mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" maxlength="55" class="form-control" value="<?php echo $showclass_id; ?>"

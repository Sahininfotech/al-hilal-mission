...
<body>
    ...
    <main id="main">
                                ...
                                <marquee behavior="scroll" direction="up" onmouseover="this.stop();"
                                    ...
                                    <div class="hmenoticesec">
                                        <a class="colorforatag"
                                            href="./admin/notice-pdf-report.php?id=45&file=notice-pdf-report"
                                            onclick="window.open('./admin/notice-pdf-report.php?id=45.pdf', '_blank', download='notice-pdf-report.php?id=45.pdf'); return false;"
                                            >1.
                                            Lorem, ipsum dolor
                                            consectetur adipisicing </a>
                                        <p class="fontsizefordate">Posted on: 26 Aug, 2022</p>
                                    </div>

                                    <div class="hmenoticesec">
                                        <a class="colorforatag"
                                            href="./admin/notice-pdf-report.php?id=45&file=notice-pdf-report"
                                            onclick="window.open('./admin/notice-pdf-report.php?id=45.pdf', '_blank');"
                                            download="notice-pdf-report.php?id=45.pdf">2.
                                            Lorem, ipsum dolor
                                            consectetur adipisicing </a>

                                        <p class="fontsizefordate">Posted on: 25 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">4. Lorem ipsum dolor sit,
                                            adipisicing elit. </a>
                                        <p class="fontsizefordate">Posted on: 24 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">5. Lorem, ipsum dolor sit amet
                                            consectetur adipisicing elit. </a>
                                        <p class="fontsizefordate">Posted on: 13 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">6. Lorem ipsum dolor sit amet
                                            consectetur Adipisci </a>
                                        <p class="fontsizefordate"> Posted on: 6 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">7. Lorem ipsum dolor sit amet
                                        </a>
                                        <p class="fontsizefordate">Posted on: 5 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">8. Lorem ipsum dolor, sit amet
                                            consectetur adipisicing elit. </a>
                                        <p class="fontsizefordate">Posted on: 4 Aug, 2022</p>
                                    </div>
                                </marquee>
                            </div>
                        </div>
        ...
        <!-- =======Principle Section ======= mousumijana2022 -->

                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php    echo $sum  ?>=<?php    echo $subPercentage  ?>%
                                                        </td>
                                                        ...
                                                        // if($subPercentage >= 10) echo 'Faill';
                                                              ...
                                                              if ($subPercentage >=11 || $subPercentage <= 20)
                                                                echo "C";
                                                              
                                                            if ($subPercentage >=21 || $subPercentage <= 40)
                                                              echo "B";
                                                            
                                                              if ($subPercentage >=41 || $subPercentage <= 60)
                                                                echo "B+";
                                                              
                                                               if ($subPercentage >=71 || $subPercentage <= 80)
                                                                   echo "A";
                                                                
                                                                  if ($subPercentage >=81 || $subPercentage <= 90)
                                                                       echo "A+";
                                                                    
                                                                        if ($subPercentage >=91 || $subPercentage <= 100)
                                                                            echo "O";

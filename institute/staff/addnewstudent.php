...
<head>
    ...
    <title>Student Management / Add new Student - NiceAdmin Bootstrap Template</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form>
                            <div class="row mb-3 d-flex justify-content-between">
                                ...
                                <!-- </div>
                            <div class="row mb-3"> -->
                                <label for="inputText" class="col-sm-2 col-form-label"> Guardian Name</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 d-flex justify-content-space-between">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="Read only / Disabled" disabled>
                            ...
                            <div class="row mb-3 d-flex justify-content-between">
                                <label class="col-sm-2 col-form-label">Documents / Id</label>
                                <div class="col-sm-4">
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Select Your Documents</option>
                                        <option value="1">Birth Certificate</option>
                                        <option value="2">Aadhar Card</option>
                                        <!-- <option value="3">3 years of experences</option> -->
                                    </select>
                                </div>

                                <label for="inputText" class="col-sm-2 col-form-label">Id Number</label>
                                <div class="col-sm-4">
                                    <input type="any" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 d-flex justify-content-between">

...
function addStudentFees($name, $roll_no, $amount, $Fees_account, $guardian_name, $class, $date, $status, $added_by, $payment_type, $payment_id, $total_amount, $student_id, $paidBy){

    $sql = "INSERT INTO `revenue_studentfees` 
            ( `name`, `roll_no`, `amount`, `Fees_account`, `guardian_name`, `class`, `date`, `payment_type`, `payment_id`, `total_amount`, `student_id`, `paid_by`, `status`,  `added_by` ) 
            VALUES 
            ('$name', '$roll_no', '$amount', '$Fees_account', '$guardian_name', '$class', '$date', '$payment_type','$payment_id', '$total_amount', '$student_id', '$paidBy', '$status', '$added_by')";
...
function showStatus(){
    ...
    function studentfeesamount(){
        ...
        $sql="SELECT  total_amount AS 'total_amount', SUM(total_amount) AS 'Total' FROM `revenue_studentfees`";

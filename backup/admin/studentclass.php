...
<body>
   ...
   echo '<div class="col-xxl-3 col-md-3">
            ...
            <div class="col-xxl-3 col-md-3">
                <div class="card">
                    <a href='submit_subject_marks.php?studentgettypesub=<?php    echo $_GET['studenttype']  ?>'>
                        <div class="card-body" style="padding: 20px 20px 20px 20px;">
               ...
               $showgurdian_name = $showStudentDetailsshow['gurdian_name'];
                         ...
                         ?>
                                        ...
                                        <tr
                                            ...
                                            <td><a
                                                    href="marks-report.php?studentclass=<?php    echo $_GET['studenttype']  ?>&studentid=<?php    echo $showstuid  ?>"><i

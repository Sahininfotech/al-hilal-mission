...
$showStudentfinalexam   = $StudentDetails->finalExampage($_GET['studentsubjecttype2']);
$showStudentDetails = $StudentDetails->showStudentmarkDetails($_GET['studentsubjecttype2']);
...
<body>
        ...
        <main id="main" class="main w-100 ms-0">
                ...
                <h1>Submit Marks</h1>
                        ...
                        <li class="breadcrumb-item"><a href="http://localhost/institute1/admin/addnewstudent.php">Student Management</a></li>
                        <li class="breadcrumb-item "><a href="http://localhost/institute1/admin/studentdetails.php">Student Details </a></li>
                ...
                <section class="section dashboard">
                        ...
                        <table class="table"> 
                                ...
                                <tbody>
                                                ...
                                                ?>
                                                <select class="form-select" aria-label="Default select example" name="session" id="session">
                                                        <option selected>Academic Session</option>
                                                ...
                                                <div class="col-sm-4">
                                                <select class="form-select" aria-label="Default select example" name="exam_id" id="exam_id">
                                                ...
                                                <tr>
                                                        ...
                                                        <td></td>
                                                        <td> 
                                                        <input type="hidden" class="form-control form_data" value="<?php  echo  $row['id']  ?>" name="id[]" id="id">
                                                                <input type="hidden" class="form-control form_data" value="<?php  echo $row['student_id']  ?>" name="student_id[]" id="<?php  echo $showstudentid  ?>">
                                                                <?php echo $row['name']  ?>
                                                        </td>

                                                        <td>
                                                                <input type="hidden" class="form-control form_data" value="<?php    echo $_GET['studentsubjecttype']  ?>" name="subject_id" id="subject_id">
                                                                <input type="hidden" class="form-control form_data" value="<?php  echo $row['class'] ?>" name="class_id" id="class_id">    
                                                                <?php    echo $row['gurdian_name']  ?>
                                                        </td>

                                                        <td> 
                                                                <input type="text" maxlength="3" id="<?php  echo $shownameid  ?>"  style="width: 4rem;" name="marks[]" required>
                                                                <i class="bi bi-x-lg ps-3" id="<?php  echo $showbtnid ?>" onclick='setAbsent("<?php    echo $shownameid  ?>", this.id)'></i>
                                                        </td>
                                                        
                                                        <td>
                                                                <input type="submit" id="save-button" class="btn btn-primary" onclick='saveItem("<?php  echo $shownameid  ?>","<?php  echo $showstudentid  ?>", this.id, this.studentid)' value="save" >
                                                        </td>
                                                </tr>
                ...
                <script>
                        ...
                        input.value = "";
                        btn.classList.remove("bi-arrow-counterclockwise");
                        btn.classList.add("bi-x-lg");
                        } else {
                        input.readOnly = true;
                        input.value = "X";
                        btn.classList.remove("bi-x-lg");
                        btn.classList.add("bi-arrow-counterclockwise");
                        }
                        }
                </script>
                ...
                <script>
                        ...
                        type: "POST",
                        data: {subject_id11:subject_id1, exam_id11:exam_id1, session11:session1, class_id11:class_id1, student_id11:student_id1, marks11:marks1},
                        success: function(data){
                        if(data == 1){
                        alert("save");
                        $("#addform").trigger("reset");
                        }else{
                        alert("save data update");
                        }
                        }
                        });
                        };

                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="filter">
                                <a href="expenses-report.php?dayreport=Today">
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6>₹ <?php echo $row->Total ; if ($row->Total== 0) echo 0;?></h6>
                    ...
                    <div class="col-xxl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="filter">
                                <a href="expenses-report.php?monthreport=Month">
                            </div>
                            <?php
                    ...
                    <div class="col-xxl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="filter">
                                <a href="expenses-report.php?yearreport=Year">
                            </div>
                        ...
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6> ₹ <?php echo $row->Total ;?><?php  if ($row->Total== 0) echo 0;?></h6>

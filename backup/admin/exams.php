...
<body>
                ...
                <div class="col-lg-6">
                    <div class="card m-0 ">
                        <div class="card-body p-3">
                            ...
                            <form method="GET" action="./ajax/exam.action.php" class="row needs-validation  m-0"
                                novalidate>
                                ...
                                <div class="row p-0 m-0 mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" maxlength="55" class="form-control" name="year" required>
                                    </div>
                                </div>
    ...
    const examShow = (id) => {
        ...
        $(".examForm-modal-body").html(
            '<iframe width="100%" height="286px" frameborder="0" allowtransparency="true" src="' + url +
            '"></iframe>')
        }

...
$eaxm = $Examination->examById($_GET['data']);
?>
        ...
        <div class="card mb-0" style="box-shadow: none">
            <div class="card-body p-3">
                ...
                <div class="row p-0 mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="55" class="form-control" value="<?php echo $showexam_name; ?>"
                ...
                <div class="row  p-0 mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="55" class="form-control" value="<?php echo $showexam_description; ?>"

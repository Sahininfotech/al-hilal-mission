...
$emps = $Employee->showEmployees();
    ...
    if(isset ($_POST["submit"])){
     ...
     if ($others_paid == '') {
        ...
        $result = $Revenue->addDonationRevenue( $name, $address, $amount, $description, $date, $status, $added_by, $pin_code, $country, $police_station, $district, $payment_type, $payment_id, $paidBy);
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="row needs-validation w-100 m-0" novalidate>
        <div class="card p-0 mb-0" style="box-shadow: none">
            <div class="card-body pt-0 p-3">
                ...
                <div class="row mb-3 m-0 p-0">
                    <label for="inputText" class="col-sm-2 col-form-label">Police Stn. :</label>
                    <div class="col-sm-4">

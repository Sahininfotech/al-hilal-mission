<?php
  ...
  $insertrevenuefees=false;
    ...
    if ($others_paid == '') {
        ...
        $result = $revenue->addStudentFees($name, $roll_no, $amount, $Fees_account, $guardian_name, $class, $date, $status, $added_by, $payment_type, $payment_id, $total_amount, $student_id, $paidBy);

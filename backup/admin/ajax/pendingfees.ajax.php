...
$result=$Student-> studentsByFees($_GET['feespending']);

$showFees_accounts   = $Student->studentFeesaccount($_GET['feespending'], $_GET['studentFees_account']);

$sameFees_accounts   = $Student->sameFeesaccount($_GET['feespending'], $_GET['studentFees_account']);
...
<body style="background: white !important;">
    <section>
        ...
        <?php
            ...
            $paidaccount       = $_GET['studentamount'];
           ...
           foreach ($sameFees_accounts as $samefee){
            ...
            $totalfeesaccount  = $amountshow - $sumdata;
            ...
            $showFees_account   = $row['Fees_account'];
        ...
        <div class="container" style="font-family: 'Nunito';">
            ...
            <div class="card minecardcss">
                <div class="row">
                    ...
                    <div class="col-6">
                        <h6 class="h6css"><?php  echo $showtotal_amount      ?></h6>
                    </div>
                    <hr class="hrcolor">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <h6 class="h6css"><?php  echo $monthly      ?></h6>
                    </div>
                    <hr class="hrcolor">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <h6 class="h6css"><?php  echo $showamount      ?></h6>
                    </div>

                    <hr class="hrcolor">
                    <div class="col-6">
                        <h6 class="h6css"><?php echo $purpose ?> : </h6>
                    </div>
                    <div class="col-6">
                        <h6 class="h6css"><?php  echo $amountshow   ?></h6>
                    </div>

                    <hr class="hrcolor">
                    <div class="col-6">
                        <h6 class="h6css">paid <?php echo $purpose ?> :</h6>
                    </div>
                    <div class="col-6">
                        <h6 class="h6css"><?php  echo $sumdata   ?></h6>
                    </div>

                    <hr class="hrcolor">
                    <div class="col-6">
                        <h6 class="h6css">pending <?php echo $purpose ?> :</h6>
                    </div>
                    <div class="col-6">
                        <h6 class="h6css"><?php if($amountshow < $sumdata) echo '<span class="badge bg-success">Paid</span>';
                          if($amountshow > $sumdata) echo $totalfeesaccount   ?></h6>
                    </div>
                    ...
                    <div class="col-6">
                        <h6 class="h6css">
                            <?php if($showtotal_amount == $showamount) echo '<span class="badge bg-success">Paid</span>';
                            if($showtotal_amount > $showamount) echo $pendingamount; 
                        ?>
                        </h6>
                    </div>
                    <hr class="hrcolor">
                    ...
                    <div class="col-6">
                        <h6 class="h6css">
                            ...
                            if($month*$monthly > $showamount) echo $monthPending;   
                            ?>
                    ...
                    <hr class="hrcolor">
                    <div class="col-6">
                        <h6 class="h6css">Fee-Account Status : </h6>
                    </div>
                    <div class="col-6">
                        <h6 class="h6css">
                        <?php 
                            if($sumdata >= $amountshow){

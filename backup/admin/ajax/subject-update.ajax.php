...
if (isset($_POST['update'])) {
    ...
    $update      = $Subjects->subjectupdate($class_name, $subject, $description);
...
<body style="background: #fff;">
    <?php
               foreach ($updatePage as $showsubjectdata) {
                ...
                $showclass_name = $showsubjectdata['class_name'];
        ...
        <div class="card p-0  mb-0" style="box-shadow: none">
            <div class="card-body p-3 pt-0">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="55" class="form-control" value="<?php echo $showclass_name; ?>"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" maxlength="55" class="form-control" value="<?php echo $showsubject; ?>" name="subject"
                            required>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" maxlength="355" style="height: 100px" value="<?php echo $showdescription; ?>"

        ...
        <div class="card p-0 mb-0" style="box-shadow: none">
            <div class="card-body pt-0 p-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?php echo $showguardian_name; ?>" id="guardian" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Roll :</label>
                    <div class="col-sm-10">
                        <input type="text" maxlength="55" class="form-control" value="<?php echo $showroll_no; ?>" required>
                    </div>
                </div>
                <div class="row mb-3">

...
require_once '../admin/class/studdetails.class.php';
$StudentDetails = new StudentDetails();
$showStudentDetails = $StudentDetails->finalexammarks($_GET['studentfinalexamtype']);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Final Exams</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card recent-sales overflow-auto p-4">
                        ...
                        <table class="table ">
                            ...
                            <tr>
                                    <th scope="row">1</th>
                                    <td>Rozy Hayat</td>
                                    <td>Md. Shamim Hussain</td>
                                    <td>100/100</td>
                                    <td>
                                        <i class="bi bi-eye-fill pe-4" data-bs-toggle="modal"
                                            data-bs-target="#editunitModal" onclick="editunit();"></i>
                                        <!-- Modal -->
    ...
    <script>
     const editunit = () => {
        let url = 'ajax/editunit.ajax.php';
        $(".editunit-modal-body").html(
            '<iframe width="99%" height="300px" frameborder="0" allowtransparency="true" src="' + url +
            '"></iframe>')

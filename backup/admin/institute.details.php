                                ...
                                <form method="post" action="#">
                                    ...
                                    <div class="col-md-11">
                                        ...
                                        <input
                                            ...
                                            type="number" maxlength="6" class="form-control" name="pin-code" id="pin"
                                            value="<?php    echo $row['pin_code']  ?>" name="pin_code">
                                    </div>
                                    <div class="col-md-11">
        ...
        <section class="section ">
            <div class="container">
                ...
                <div class="col-md-12">
                   ...
                   if(!$princpleupdateEmpQuery){
                     ?>
                            <form class="col-md-9 ms-auto" method="post" action="#">
                                <div class="col-md-8  ">
                                    <label class="mb-0 mt-1" for="Principle name">Principle Name</label>

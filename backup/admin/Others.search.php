...
$showerevenuesDetails = $revenues->showerevenuesDetails($_GET['searchothers1'] , $_GET['searchothers'] );
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-sm-3 border-start border-dark " style="line-height: 0.5rem;">
                            ...
                            <p class="ps-4"> <?php    echo $_GET['searchothers1']  ?> <br><br> to <br><br> <?php    echo $_GET['searchothers']  ?></p>
    ...
    <!-- 
                ...
                <!-- <div class="col-lg-8 m-auto mt-2">
                  ...
                  $revenues = new  Revenueclass();
                       ...
                       $result=$revenues->finddataothers($_GET['searchothers1'] , $_GET['searchothers'] );

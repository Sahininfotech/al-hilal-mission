...
$revenueamounts       = $revenues->studentfeesamount();
                            ...
                            <div class="card indexedcrd info-card sales-card">
                                <div class="filter">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <li><a class="dropdown-item" href="student-report.php?dayreport=Today">Today</a>
                                        </li>
                                        <li><a class="dropdown-item" href="student-report.php?monthreport=Month">This
                                                Month</a></li>
                                        <li><a class="dropdown-item" href="student-report.php?yearreport=Year">This
                                                Year</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="card indexedcrd info-card sales-card">
                                <div class="filter">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <li><a class="dropdown-item" href="pending-report.php?dayreport=Today">Today</a></li>
                                        <li><a class="dropdown-item" href="pending-report.php?monthreport=Month">This Month</a></li>
                                        <li><a class="dropdown-item" href="pending-report.php?yearreport=Year">This Year</a></li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                ...
                                                <h6 style="color: red;" ><?php echo $penDingamount ; if ($penDingamount== 0) echo 0;?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <div class="filter">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="revenuestudent-report.php?dayreport=Today">Today</a></li>
                                        <li><a class="dropdown-item"
                                                href="revenuestudent-report.php?monthreport=Month">This Month</a></li>
                                        <li><a class="dropdown-item"
                                                href="revenuestudent-report.php?yearreport=Year">This Year</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="card indexedcrd info-card sales-card">
                                <div class="filter">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="expenses-report.php?dayreport=Today">Today</a></li>
                                        <li><a class="dropdown-item" href="expenses-report.php?monthreport=Month">This
                                                Month</a></li>
                                        <li><a class="dropdown-item" href="expenses-report.php?yearreport=Year">This
                                                Year</a></li>
                                    </ul>
                                </div>
                                <?php

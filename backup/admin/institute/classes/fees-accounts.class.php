...
class FeesAccount extends DatabaseConnection{
    ...
    function addFeesAccounts($student_id, $discount, $name, $conc_remark, $payable_fee){

        $sql = "INSERT INTO `student_fees_dtls` (`student_id`, `concession`, `name`, `conc_remark`, `payable_fee`)
                                            VALUES
                                            ('$student_id', '$discount', '$name', '$conc_remark', '$payable_fee')";
    ...
    function feesSummary($student_id, $name, $class, $total_due, $advanced, $amount, $date, $added_by, $total_duess, $advanceds){
     ...
     function feesSummarydata($student_id, $total_due, $total_duess){
        ...
        if ($row == 0) {
           ...
           $sqlup = "UPDATE `student` SET `total_due` = '$total_due' WHERE  `student`.`student_id` = '$student_id'";
        ...
        {   
            ...
            $sqleditup = "UPDATE `student` SET `total_due` = '$total_duess' WHERE  `student`.`student_id` = '$student_id'";

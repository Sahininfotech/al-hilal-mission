...
$sql = "INSERT INTO `student` ( `student_id`,`name`, `email`, `gurdian_name`, `contact_no`, `gender`, `post_office`, `police_station`,`pin_code`, `sdo_or_bdo`, `district`, `state`, `date_of_birth`, `class`, `stream`,`address`, `academic_year`, `status`, `roll_no`,  `total_amount`, `total_due`, `date`)           
VALUES ( '$student_id', '$name',  '$email', '$gurdian_name', '$contact_no',  '$gender', '$post_office', '$police_station', '$pin_code',  '$sdo', '$district', '$state', '$date_of_birth', '$class', '$stream','$address','$academic_year', '$status', '$roll_no', '$total_amount', '$total_amount',current_timestamp())";

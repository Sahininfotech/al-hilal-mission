                            ...
                            <div class="card recent-sales overflow-auto p-4">
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    foreach ($showStudent as $showrowstu) {
                                        ...
                                        $showtotal_amount   = $showrowstu['total_amount'];
                                ...
                                ?>
                                        ...
                                        <tr
                                            <?php if ($showrowstu['status']== 'active') echo 'style="color: black"' ; if ($showrowstu['status']== 'inactive') echo 'style="color: red"' ;?>>
                                            ...
                                            <td><?php  echo $showtotal_amount        ?></td>

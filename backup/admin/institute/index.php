                            ...
                            <div class="noticebar-content clearfix">
                                <marquee behavior="scroll" direction="up" onmouseover="this.stop();"
                                    ...
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">1. Lorem, ipsum dolor
                                            consectetur adipisicing </a>
                                        <p class="fontsizefordate">Posted on: 26 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">2. Lorem ipsum dolor sit amet
                                            consectetur</a>
                                        <p class="fontsizefordate">Posted on: 25 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">
                                        <a class="colorforatag" href="" target="_blank">3. Lorem ipsum dolor sit, amet
                                            consectetur elit. </a>
                                        <p class="fontsizefordate">Posted on: 25 Aug, 2022</p>
                                    </div>
                                    <div class="hmenoticesec">

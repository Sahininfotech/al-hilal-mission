...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="col-xxl-3 col-md-3">
      <a href="studentclass-1.php">
      <div class="card info-card sales-card">
    
       
    
        <div class="card-body">
          <h5 class="card-title">Class <span>| 1</span></h5>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ps-3">
              <h4>100</h4>
              <span class="text-success small pt-1 fw-bold">Total</span> <span class="text-muted small pt-2 ps-1">Student increase this year.</span>
    ...
    <div class="col-xxl-3 col-md-3">
      ...
      <div class="card info-card sales-card">
        ...
        <div class="card-body">
          <h5 class="card-title">Class <span>| 2</span></h5>
    ...
    <div class="col-xxl-3 col-md-3">
      ...
      <div class="card info-card sales-card">
        ...
        <div class="card-body">
          <h5 class="card-title">Class <span>| 3</span></h5>
    ...
    <div class="col-xxl-3 col-md-3">
      ...
      <div class="card info-card sales-card">
        ...
        <div class="card-body">
          <h5 class="card-title">Class <span>| 4</span></h5>

...
function othersfeesYear(){
    ...
    //updateStudentFees start
    function updateStudentFees($name, $roll_no, $class, $amount, $id, $status, $payment_type, $date, $payment_id, $paid_by){
    ...
    //start revenuefeesinsert

    function revenuefeesinsert( $name, $roll_no, $amount, $class, $date, $status, $added_by, $payment_type, $payment_id, $total_amount, $student_id, $paidBy){

        $sql = "INSERT INTO `revenue_studentfees` (`name`, `roll_no`, `amount`, `class`,`date`, `status`,  `added_by`, `payment_type`, `payment_id`, `total_amount`, `student_id`, `paid_by`) VALUES ('$name', '$roll_no', '$amount', '$class', '$date', '$status', '$added_by', '$payment_type','$payment_id', '$total_amount', '$student_id', '$paidBy')";

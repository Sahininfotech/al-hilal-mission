...
class FeesAccount extends DatabaseConnection{
    ...
    function addFeesAccounts($student_id, $discount, $name, $conc_remark, $payable_fee, $gurdian_name, $academic_year, $roll_no, $class){
        ...
        $sql = "INSERT INTO `student_fees_dtls` (`student_id`, `concession`, `name`, `conc_remark`, `payable_fee`, `gurdian_name`, `session`, `roll_no`, `class`, `total_due`, `added_on`)
                                            VALUES
                                            ('$student_id', '$discount', '$name', '$conc_remark', '$payable_fee', '$gurdian_name', '$academic_year', '$roll_no', '$class', '$payable_fee', current_timestamp())";

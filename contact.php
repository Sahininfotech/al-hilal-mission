...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if(isset ($_POST["submit"])){
    ...
    //  }
            ...
            $added = $Contact->contactInsert( $name,  $email, $subject, $message, $status);
...
<script>
alert('Your Message has been sent successfully!');document.location='contact.php';
</script>
...
<script>
alert('Sorry! Message was not sent, Try again Later.');document.location='contact.php';
</script>
...
<head>
    ...
    <title>Contact Us Today | <?php echo SITE_NAME; ?></title>
          ...
          ?>
                ...
                <div class="sent-message">Your message has been sent. Thank you!</div>
                            ...
                            <div class="text-center mb-5">
                                ...
                                <button type="submit" name="submit" class="sendingmssg-contact mt-3">Send
                                    Message</button>
